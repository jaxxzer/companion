...
if pip list | grep pynmea2; then
    ...
    sudo pip install --no-index --find-links /home/jack/update-dependencies/pynmea2-pip pynmea2
...
if pip list | grep grequests; then
    ...
    sudo unzip -q -o /home/jack/update-dependencies/grequests.zip -d /
    echo 'installing grequests...'
    sudo pip install --no-index --find-links /home/jack/update-dependencies/grequests-pip grequests
...
rm -rf /home/jack/update-dependencies
