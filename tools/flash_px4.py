...
if options.file is not None:
    if(os.system("python -u /home/jack/companion/tools/px_uploader.py --port /dev/ttyACM0 '%s'" % options.file) != 0):
                print "Error flashing pixhawk!"
                exit(1)
else:
    if(os.system("python -u /home/jack/companion/tools/px_uploader.py --port /dev/ttyACM0 /tmp/ArduSub-v2.px4") != 0):
