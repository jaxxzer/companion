...
app.get("/udevadm", function(req, res) {
    ...
    var result = child_process.execSync(_companion_directory + "/tools/query-udevadm.py --indent=2 " + pattern);
...
app.get("/screen", function(req, res) {
    ...
    var result = child_process.execSync(_companion_directory + "/tools/query-screen.py --indent=2 " + user);
    res.setHeader('Content-Type', 'application/json');
    res.send(result.toString());
});
